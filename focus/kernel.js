...
// include: /tmp/tmpy49e1iny.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/out/kernel.data';
      var REMOTE_PACKAGE_BASE = 'kernel.data';
    ...
    async function runWithFS(Module) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_build/out/kernel.data');
      }
      Module['addRunDependency']('datafile_build/out/kernel.data');
    ...
    loadPackage({"files": [{"filename": "/disk.vhd", "start": 0, "end": 83886592}], "remote_package_size": 83886592});

  })();

// end include: /tmp/tmpy49e1iny.js
// include: /tmp/tmpuqjzsx73.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpuqjzsx73.js
// include: /tmp/tmpson6aeqn.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpson6aeqn.js
...
var ASM_CONSTS = {
  78964: ($0, $1) => { var canvas = document.getElementById('canvas'); if (canvas) { setValue($0, canvas.width, 'i32'); setValue($1, canvas.height, 'i32'); } },  
 79103: ($0, $1, $2, $3) => { setInterval(()=>{ var canvas = document.getElementById('canvas'); var ctx = canvas.getContext('2d'); var imageData = ctx.createImageData($1, $2); var heap = new Uint8Array(Module.HEAPU8.buffer, $0, $1 * $2 * 4); imageData.data.set(heap); ctx.putImageData(imageData, 0, 0); },$3); },  
 79387: ($0, $1, $2) => { var canvas = document.getElementById('canvas'); var ctx = canvas.getContext('2d'); var imageData = ctx.createImageData($1, $2); var heap = new Uint8Array(Module.HEAPU8.buffer, $0, $1 * $2 * 4); imageData.data.set(heap); ctx.putImageData(imageData, 0, 0); },  
 79646: () => { if (typeof window.startInput === 'function') { window.startInput(); } },  
 79720: () => { if (typeof window.handleBackspace === 'function') { window.handleBackspace(); } },  
 79804: () => { if (typeof window.endInput === 'function') { window.endInput(); } },  
 79874: ($0) => { console.log(UTF8ToString($0)); },  
 79909: ($0) => { console.log(UTF8ToString($0)); },  
 79944: ($0) => { console.log(UTF8ToString($0)); }
};
