...
// end include: /tmp/tmp5evywm4w.js
// include: /tmp/tmpadi50288.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpadi50288.js
// include: /tmp/tmp5wziujrc.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp5wziujrc.js
...
var ASM_CONSTS = {
  87252: ($0, $1) => { var canvas = document.getElementById('canvas'); if (canvas) { setValue($0, canvas.width, 'i32'); setValue($1, canvas.height, 'i32'); } },  
 87391: ($0, $1, $2, $3) => { setInterval(()=>{ var canvas = document.getElementById('canvas'); var ctx = canvas.getContext('2d'); var imageData = ctx.createImageData($1, $2); var heap = new Uint8Array(Module.HEAPU8.buffer, $0, $1 * $2 * 4); imageData.data.set(heap); ctx.putImageData(imageData, 0, 0); },$3); },  
 87675: ($0, $1, $2) => { var canvas = document.getElementById('canvas'); var ctx = canvas.getContext('2d'); var imageData = ctx.createImageData($1, $2); var heap = new Uint8Array(Module.HEAPU8.buffer, $0, $1 * $2 * 4); imageData.data.set(heap); ctx.putImageData(imageData, 0, 0); },  
 87934: ($0) => { console.log(UTF8ToString($0)); },  
 87969: ($0) => { console.log(UTF8ToString($0)); },  
 88004: ($0) => { console.log(UTF8ToString($0)); }
};
